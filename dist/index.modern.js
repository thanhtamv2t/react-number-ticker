import React__default, { useState, useRef, useMemo, useEffect, createElement, Fragment } from 'react';
...
var TickerNumber = function TickerNumber(_ref) {
  ...
  var arrNumber = useMemo(function () {
...
var ReactNumberTicker = function ReactNumberTicker(_ref) {
  ...
  return createElement("div", {
    ...
    return createElement(TickerNumber, {
      key: "text-" + index + "-time",
      num: parseInt(it),
      index: index
    });
